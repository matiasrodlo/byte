"""
RobotDog LLM Server Client
=========================
Client application for controlling RobotDog using a local LLM server.
"""
...
parser = argparse.ArgumentParser(description="RobotDog client to interact with an LLM server.")
parser.add_argument(
    '--server_url',
    type=str,
...
try:
    ...
    print(f"\033[31mERROR: Failed to initialize RobotDog: {e}\033[m")
    sys.exit(1)
...
def main():
    ...
    print(f"RobotDog Client started. LLM Server URL: {cli_args.server_url}")

"""
IMU (Inertial Measurement Unit) Test Script
==========================================
Tests the SH3001 IMU sensor with calibration and real-time data display.
"""

from byte.sh3001 import Sh3001
...
UserHome = os.popen('getent passwd %s | cut -d: -f 6' %
                    User).readline().strip()
config_file = '%s/.config/byte/byte.conf' % UserHome

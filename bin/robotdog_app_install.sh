#!/bin/bash
#
# RobotDog System Installation Script
# ===================================
...
VER="1.0.0"
echo "RobotDog Installation Script v$VER"
...
# ========================
if [ $(id -u) -ne 0 ]; then
  printf "Script must be run as root. Try 'sudo bash robotdog_app_install.sh'\n"
  exit 1
fi
...
echo -e "${GREEN}install robotdog_app interactive commands ...${NC}"
cp ./robotdog_app /usr/local/bin/
chmod +x /usr/local/bin/robotdog_app

# ==================================== auto-start ====================================
echo -e "${GREEN}install robotdog_app auto-start service ...${NC}"
# https://www.raspberrypi.com/documentation/computers/configuration.html#software-install

# https://www.freedesktop.org/software/systemd/man/systemd.service.html

cat > /usr/lib/systemd/system/robotdog_app.service << EOF
[Unit]
Description=robotdog_app service
...
# sudo systemctl status robotdog_app.service
# journalctl -u robotdog_app.service
# journalctl -u robotdog_app.service --lines=50

# =============================== AP mode =============================================
DEFAULT_WIFI_SSID="robotdog"

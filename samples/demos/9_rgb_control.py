#!/usr/bin/env python3
"""
RGB Strip Control Example
========================
Basic example showing how to control the RGB LED strip with various styles and colors.

API:
    RobotDog.rgb_strip.set_mode(style='breath', color='white', bps=1, brightness=1):
    ...
    RobotDog.rgb_strip.close():
        - turn off rgb display


more to see: ../byte/rgb_strip.py

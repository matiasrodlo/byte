#!/usr/bin/env python3
"""
RobotDog Initialization Example
===============================
Basic example showing how to initialize the RobotDog with custom servo angles.
...
# Import RobotDog class
from byte import RobotDog

# instantiate a RobotDog with default parameters
# my_dog = RobotDog()

# instantiate a RobotDog with custom initialized servo angles
my_dog = RobotDog(leg_init_angles = [25, 25, -25, -25, 70, -45, -70, 45],

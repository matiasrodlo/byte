#!/usr/bin/env python3
"""
Legs Control Example
===================
Basic example showing how to control the robot's leg servos.

API:
    RobotDog.legs_move(target_angles, immediately=True, speed=50)

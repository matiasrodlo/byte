#!/usr/bin/env python3
"""
RobotDog Balance Control Example
==============================
Advanced example demonstrating balance control and walking with keyboard input.
"""
...
usage = '''
\033[104m\033[1m  RobotDog       Balance         Ctrl + C to Exit  \033[0m
    ┌────────┐┌────────┐┌────────┐┌────────┐
    │Q       ││W       ││E       ││R       │
    │        ││        ││        ││        │
    │        ││ Forward││  Stand ││   UP   │
